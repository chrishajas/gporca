...
CConstraintTest::EresUnittest_CConstraintIntervalFromArrayExpr()
{
	...
	CColRef *pcrNot = pexprNotIn->PcrsOutput()->PcrAny();
	...
	CColRef *pcrInRepeats = pexprInRepeatsSelect->PcrsOutput()->PcrAny();
	...
	CColRef *pcrNotInRepeats = pexprNotInRepeatsSelect->PcrsOutput()->PcrAny();
...
EresUnittest_CConstraintIntervalFromArrayExprIncludesNull()
{
	...
	CColRef *colref = pexprIn->PcrsOutput()->PcrAny();
