	...
	)
{
	...
	{
        // TODO
		if (CStatsPred::EstatscmptEq != stats_cmp_type && CStatsPred::EstatscmptEqNDV != stats_cmp_type && !IMDType::StatsAreComparable(col_ref_left->RetrieveType(), col_ref_right->RetrieveType()))
		{
