	...
	class CXformApply2Join : public CXformExploration
	{
		...
		protected:
			...
			void CreateJoinAlternative(CXformContext *pxfctxt, CXformResult *pxfres, CExpression *pexprApply)
            {
                ...
                GPOS_ASSERT_IMP(CUtils::HasOuterRefs((*pexprApply)[1]), !exprhdl.GetRelationalProperties(1)->PcrsOuter(exprhdl)->ContainsAll(exprhdl.GetRelationalProperties(0)->PcrsOutput())
